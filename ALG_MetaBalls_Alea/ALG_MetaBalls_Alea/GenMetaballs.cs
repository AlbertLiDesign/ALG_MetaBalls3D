...
namespace ALG.MetaBalls3D
{
    public class Metaballs
    {
        ...
        public Metaballs() { }
        public Metaballs(Point3d basePoint, int xCount, int yCount, int zCount,
            float scale, float isoValue, float fusion, List<Point3d> samplePoints)
        {
            this.basePoint = basePoint;
            this.gridSize.x = xCount;
            this.gridSize.y = yCount;
            this.gridSize.z = zCount;

            this.voxelSize.x = scale;
            this.voxelSize.y = scale;
            this.voxelSize.z = scale;
